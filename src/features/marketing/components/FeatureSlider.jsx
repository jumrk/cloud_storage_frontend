    ...
    <div className="grid w-full grid-cols-1 items-stretch gap-4 md:grid-cols-2">
      {features.map((item, idx) => (
        <ScrollReveal key={idx}>
          <div className="group relative flex h-full w-full flex-1 flex-col items-center rounded-xl border border-accent-100 bg-white p-4 shadow transition-transform duration-200 hover:-translate-y-1 hover:border-accent-500">
            ...
            <div className="text-gray-600 max-w-md text-center text-sm md:text-base">
              {item.desc}
            </div>
          </div>
        </ScrollReveal>
