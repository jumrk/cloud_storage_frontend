    ...
    <div className="w-full min-h-screen bg-surface-50 pb-16">
      <div className="mx-auto flex max-w-5xl flex-col gap-10 px-4 pt-10 md:flex-row">
        ...
        <aside className="w-64 flex-shrink-0">
          <div className="sticky top-4 rounded-xl border border-border bg-white p-4 shadow">
            <h3 className="mb-4 font-semibold text-text-strong">
            ...
            <nav className="space-y-2">
              {sections.map((section) => (
                <button
                  ...
                  className="block w-full py-1 text-left text-sm text-text-muted transition-colors hover:text-brand"
                >
                  {section.label}
                </button>
              ))}
