    ...
    <div className="md:px-14 flex w-full min-h-[60vh] flex-col items-center justify-between gap-8 md:flex-row">
      <div className="flex max-w-2xl flex-1 flex-col gap-6">
        <ScrollReveal direction="down">
          <h1 className="text-text-strong md:text-5xl flex flex-col gap-2 text-3xl font-bold leading-tight">
            <div>
        ...
        <ScrollReveal direction="up">
          <div className="mt-10 flex gap-12">
            <div className="flex flex-col items-center">
              ...
              />
              <span className="text-text-strong text-xl font-bold">20K+</span>
              <span className="text-text-muted text-sm">{t("hero.users")}</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              <Lottie
                ...
                className="mb-1 h-12 w-12"
              />
              <span className="text-text-strong text-xl font-bold">1M+</span>
              <span className="text-text-muted text-sm">{t("hero.files")}</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              <Lottie
                ...
                className="mb-1 h-12 w-12"
              />
              <span className="text-text-strong text-xl font-bold">1 PB</span>
