              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <ScrollReveal direction="up">
                  <div className="bg-white rounded-lg p-5 shadow">
                    ...
                    <p className="text-gray-600">{t("faq.1_a")}</p>
                  </div>
                </ScrollReveal>
                <ScrollReveal direction="up">
                  <div className="bg-white rounded-lg p-5 shadow">
                    ...
                    <p className="text-gray-600">{t("faq.2_a")}</p>
                  </div>
                </ScrollReveal>
                <ScrollReveal direction="up">
                  <div className="bg-white rounded-lg p-5 shadow">
                    ...
                    <p className="text-gray-600">{t("faq.3_a")}</p>
                  </div>
                </ScrollReveal>
                <ScrollReveal direction="up">
                  <div className="bg-white rounded-lg p-5 shadow">
                    ...
                    <p className="text-gray-600">{t("faq.4_a")}</p>
                  </div>
                </ScrollReveal>
                <ScrollReveal direction="up">
                  <div className="bg-white rounded-lg p-5 shadow">
                    ...
                    <p className="text-gray-600">{t("faq.5_a")}</p>
                  </div>
                </ScrollReveal>
              </div>
            </div>
            <div className="w-full mt-16">
              <section className="bg-gray-100 mx-auto mb-10 flex w-full max-w-5xl flex-col items-center gap-8 rounded-xl p-6 md:flex-row md:items-stretch md:gap-12 md:p-12">
                <div className="flex flex-1 flex-col text-center md:items-start md:text-left">
                  <h2 className="text-gray-900 mb-4 text-2xl font-semibold leading-tight md:text-5xl">
                ...
                <div className="flex flex-1 flex-col items-center justify-center text-center md:items-start md:text-left">
                  <p className="text-gray-600 mb-6 max-w-xl text-sm md:text-base">
                    {t("cta.desc")}
                  </p>
                  <a
                    href="#plan-section"
                  ...
                  >
                    {t("cta.btn")} <span className="ml-1">→</span>
                  </a>
                </div>
              </section>
            </div>
