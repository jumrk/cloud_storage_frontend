        ...
        {hasOverflow && (
          <div className="flex items-center gap-2">
            <button
              ...
              className={`h-8 w-8 cursor-pointer rounded-full border border-border bg-white shadow-sm grid place-items-center transition ${
            ...
            <button
              type="button"
              onClick={() => scrollByCards(1)}
              className={`h-8 w-8 rounded-full cursor-pointer border border-border bg-white shadow-sm grid place-items-center transition ${
