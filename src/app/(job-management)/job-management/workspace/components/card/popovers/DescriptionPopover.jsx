...
export default function DescriptionPopover({
  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder: t("job_management.description.write_description_placeholder"),
      }),
    ],
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm max-w-none focus:outline-none min-h-[180px] p-3 bg-white text-text-strong " +
  ...
  const IconBtn = ({ onClick, active, title, children, disabled }) => (
    <button
      ...
      className={[
        ...
        active ? "bg-surface-50 ring-1 ring-border" : "bg-white",
        "text-text-strong disabled:opacity-40 disabled:cursor-not-allowed",
        "transition",
      ].join(" ")}
    >
      {children}
  ...
  const applyLink = () => {
    ...
    const url = prompt(t("job_management.description.enter_url"), prev || "https://");
    if (url === null) return;
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-3 py-2 border-b border-border">
        <span className="font-medium text-text-strong">{t("job_management.board.description")}</span>
        <button
      ...
      <div className="px-3 pt-3">
        <div className="flex items-center gap-2 flex-wrap text-text-strong">
          <div className="relative">
            ...
            {styleMenu && (
              <div className="absolute mt-2 w-44 rounded-lg border border-border bg-white shadow-xl overflow-hidden z-10">
                <button
      ...
      <div className="pt-2">
        <div className="mx-3 rounded-xl border border-border bg-white overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-3 py-3">
        ...
        <button
          onClick={onClose}
          className="h-9 px-4 rounded-lg border border-border text-text-strong text-sm bg-white hover:bg-surface-50"
        >
        ...
        <button
          onClick={clear}
          className="h-9 px-3 rounded-lg border border-border text-text-muted text-sm bg-white hover:bg-surface-50"
