  ...
  return (
    ...
    >
        ...
        >
          ...
          {!adding ? (
            <div
              ...
              className="flex cursor-pointer transition-all duration-200 justify-center items-center w-[352px] h-[560px] rounded-2xl min-w-[352px] border border-dashed border-border bg-white shadow-sm hover:border-brand-300 hover:border-2"
            >
              <div className="inline-flex items-center gap-1 text-sm text-text-muted border border-border rounded-full px-3 py-1.5">
                <IoAdd className="text-text-muted" />
                {t("job_management.board.add_list")}
              </div>
            </div>
          ) : (
            <div className="flex cursor-default transition-all duration-200 justify-center items-center w-[352px] min-w-[352px] h-[560px] rounded-2xl border border-dashed border-border bg-white shadow-sm hover:border-brand-300 hover:border-2">
              <form onSubmit={submit} className="space-y-3" data-drag-ignore>
                <input
                  ...
                  className="w-full rounded-xl border border-border bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-brand-200 focus:border-brand-300"
                />
      ...
      <DragOverlay dropAnimation={null}>
        {overlayCard ? (
          <div className="rounded-2xl border border-border bg-white shadow-lg w-[320px] p-3">
            <div
              className="font-medium text-text-strong truncate"
