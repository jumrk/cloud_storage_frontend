  ...
  return (
    <div className="flex items-center relative gap-2 py-1">
      ...
      <input
        ...
        className={` min-w-0 flex-1 h-9 rounded-lg border bg-white px-3 text-sm outline-none focus:border-brand-300 focus:ring-4 focus:ring-brand-100 ${
          item.isDone ? "line-through text-gray-600" : "text-gray-900"
        } border-gray-200 `}
      ...
      <button
        type="button"
        className="h-9 w-9 grid place-items-center rounded-lg text-gray-600 hover:text-danger-600 hover:bg-danger-50 active:bg-danger-100 transition-colors"
