...
export default function LabelPopover({
  ...
  return (
    <div
      ref={panelRef}
      className={`absolute z-50 top-full mt-2 w-72 rounded-xl border border-gray-200 bg-white shadow-xl ${className}`}
    ...
    >
      <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200">
        <span className="font-medium text-gray-900">
          {t("job_management.card.select_color_label")}
        </span>
        <button
      ...
      <div className="p-3 space-y-3">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-200">
          ...
          {selected.length > 0 && (
            <button
              className="text-sm px-2 py-1 rounded-md hover:bg-white"
              onClick={clearAll}
            >
              Bỏ chọn hết
            </button>
