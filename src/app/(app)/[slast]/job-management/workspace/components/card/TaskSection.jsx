        ...
        {hasOverflow && (
          <div className="flex items-center gap-2">
            <button
              ...
              className={`h-8 w-8 cursor-pointer rounded-full border border-gray-200 bg-white shadow-sm grid place-items-center transition ${
                atStart ? "opacity-40 pointer-events-none" : "hover:shadow"
              }`}
              aria-label="Prev"
            >
            ...
            <button
              type="button"
              onClick={() => scrollByCards(1)}
              className={`h-8 w-8 rounded-full cursor-pointer border border-gray-200 bg-white shadow-sm grid place-items-center transition ${
                atEnd ? "opacity-40 pointer-events-none" : "hover:shadow"
              }`}
              aria-label="Next"
            >
