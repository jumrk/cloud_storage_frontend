...
export function BasicTable({
  ...
  return (
    <div className="ml-5 mr-2 md:block hidden">
      <div className="bg-white overflow-x-auto rounded-xl border border-gray-200">
          ...
          <thead>
            <tr className="bg-white text-gray-900">
              {columns.map((key) => (
                <th
                  key={key}
                  className="px-5 py-3 font-semibold text-left border-b border-gray-200 cursor-pointer hover:bg-white transition-colors"
          ...
          <tbody>
            {loading
              ...
              : rows.map((row, i) => (
                  <tr
                    key={i}
                    className="hover:bg-white border-b border-gray-200 transition"
                  >
