    ...
    <div className="flex flex-col gap-2 mt-2">
      {types.map((t) => (
        <div key={t.ext} className="flex items-center gap-2 text-sm">
          ...
          <div className="flex-1 h-3 bg-gray-100 rounded-full relative overflow-hidden border border-gray-200">
            <div
          ...
          <span className="ml-2 text-xs text-gray-600">{t.count} file</span>
        </div>
      ))}
    </div>
  );
