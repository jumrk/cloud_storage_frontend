...
export default function SharedPage() {
  ...
  return (
    <div className="p-6 space-y-5 bg-white h-full">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{t("title")}</h1>
          <p className="text-sm text-gray-600">{t(`description.${tab}`)}</p>
        </div>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
        {loading ? (
          ...
          <div className="py-16 text-center text-gray-600">{t("empty")}</div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead className="bg-white text-left text-sm font-semibold text-gray-600 uppercase tracking-wide">
                <tr>
