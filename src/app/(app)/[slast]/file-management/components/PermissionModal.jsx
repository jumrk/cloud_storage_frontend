...
const PermissionModal = ({ isOpen, onClose, folder, onPermissionChange }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-6 w-full max-w-lg max-h-[80vh] overflow-y-auto shadow-2xl border border-gray-200 relative animate-fade-in">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-600 hover:text-brand text-2xl font-bold transition-all"
        ...
        <div className="mb-2">
          <h4 className="font-semibold mb-3 text-gray-900 text-lg text-left">
          ...
          <div className="divide-y divide-border border rounded-xl overflow-hidden bg-white">
            {isLoadingList ? (
              ...
              <div className="p-6 text-gray-600 text-center bg-white">
              ...
              members.map((member) => {
                ...
                return (
                  <div
                    key={member._id}
                    className="flex items-center justify-between px-4 py-4 bg-white hover:bg-white transition-all"
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isFolder && locked !== null && (
                        <button
                          ...
                          disabled={loading}
                          className="ml-2 px-2 py-1 rounded-lg bg-white text-gray-900 text-xs hover:bg-white border border-gray-200 transition disabled:opacity-50 shadow"
