...
function MobileOverview() {
  ...
  const usedStorage = "120 GB";
  const totalStorage = "200 GB";
  const usedStorageNum = 120;
  const totalStorageNum = 200;
  return (
    <div className="block md:hidden px-4 pt-6 pb-4">
      <div className="bg-white rounded-xl shadow p-5">
        ...
        <StoragePieChart used={usedStorageNum} total={totalStorageNum} />
      </div>
    </div>
  );
}
